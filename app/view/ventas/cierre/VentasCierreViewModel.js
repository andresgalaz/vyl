    ...
    stores: {
        ...
        stFormulariosIngresados: {
            fields: [
				...
				{ name: 'LOTEO', type: 'string' },
				{ name: 'PARCELA', type: 'string' },
        ...
        stNacionalidad: {
            fields: ['COD', 'NACIONALIDAD', 'COD_F', 'COD_M'],
            
            data: [
                {COD: 'chile',           NACIONALIDAD: 'Chilena',           COD_F: 'chilena',           COD_M: 'chileno'},
                {COD: 'argentina',       NACIONALIDAD: 'Argentina',         COD_F: 'argentina',         COD_M: 'argentino'},
                {COD: 'bolivia',         NACIONALIDAD: 'Boliviana',         COD_F: 'boliviana',         COD_M: 'boliviano'},
                {COD: 'brasil',          NACIONALIDAD: 'Brasileña',         COD_F: 'brasileña',         COD_M: 'brasileño'},
                {COD: 'colombia',        NACIONALIDAD: 'Colombiana',        COD_F: 'colombiana',        COD_M: 'colombiano'},
                {COD: 'ecuador',         NACIONALIDAD: 'Ecuatoriana',       COD_F: 'ecuatoriana',       COD_M: 'ecuatoriano'},
                {COD: 'paraguay',        NACIONALIDAD: 'Paraguaya',         COD_F: 'paraguaya',         COD_M: 'paraguayo'},
                {COD: 'peru',            NACIONALIDAD: 'Peruana',           COD_F: 'peruana',           COD_M: 'peruano'},
                {COD: 'uruguay',         NACIONALIDAD: 'Uruguaya',          COD_F: 'uruguaya',          COD_M: 'uruguayo'},
                {COD: 'venezuela',       NACIONALIDAD: 'Venezolana',        COD_F: 'venezolana',        COD_M: 'venezolano'},
        ...
        stSexo: {
            ...
            data: [
                {COD: 'femenino', SEXO: 'Femenino'},
                {COD: 'masculino', SEXO: 'Masculino'}
            ]
        },
    }
});
