...
Proxys configurados y direccionados a servicios del Compustrom.
...
Objetos propios del workflow que se utilizan en las distintas vistas.
...
This area is intended for overrides like these:
    ...
    Ext.define('vyl.overrides.foo.Bar', {
...
Corresponde a la compilación realizada mediante sencha cmd utilizando los comandos sencha app watch o sencha app build. 
El archivo app.json fue modificado para que el path del "output" se direccione a esta carpeta.
